...
namespace ClariSLiveSetList.Shared.Models
{
    ...
    public class LiveDataManager
    {
        ...
        public LiveDataManager()
        {
            ...
            LiveList.Add( new LiveData( 43, "ClariS AUTUMN TOUR 2024 ～Via Fortuna～", "LINE CUBE SHIBUYA（東京都）", new DateTime( 2024, 10, 26, 13, 0, 0 ), "", "コネクト", "仮面ジュブナイル", "Prism", "CLICK", "again", "Gravity", "SHIORI", "blossom", "PRIMALove", "秋のグラディエント", "風は秋色", "木枯らしに抱かれて", "月のしずく", "思秋期", "ヒトリゴト", "CheerS", "アリシア", "ALIVE", "シニカルサスペンス", "Masquerade", "ふぉりら", "コイセカイ", "recall", "君がいると", "アイデンティティ", "陽だまり", "Evergreen", "Clear Sky", "PRECIOUS", "border" ) );
            LiveList.Add( new LiveData( 43, "ClariS AUTUMN TOUR 2024 ～Via Fortuna～", "LINE CUBE SHIBUYA（東京都）", new DateTime( 2024, 10, 26, 18, 0, 0 ), "", "コネクト", "仮面ジュブナイル", "Prism", "CLICK", "again", "Gravity", "SHIORI", "Brave", "アネモネ", "秋のグラディエント", "風は秋色", "木枯らしに抱かれて", "月のしずく", "思秋期", "ヒトリゴト", "CheerS", "シグナル", "ALIVE", "シニカルサスペンス", "Masquerade", "ふぉりら", "アンダンテ", "recall", "君がいると", "アイデンティティ", "陽だまり", "Evergreen", "Clear Sky", "PRECIOUS", "border" ) );
            ...
            LiveList.Add( new LiveData( 43, "ClariS AUTUMN TOUR 2024 ～Via Fortuna～", "Zepp Namba（大阪府）", new DateTime( 2024, 11, 10 ), "", "Clear Sky", "コネクト", "仮面ジュブナイル", "Prism", "CLICK", "again", "Gravity", "SHIORI", "blossom", "秋のグラディエント", "風は秋色", "木枯らしに抱かれて", "月のしずく", "思秋期", "border", "ヒトリゴト", "CheerS", "アリシア", "ALIVE", "シニカルサスペンス", "ふぉりら", "コイセカイ", "recall", "君がいると", "アイデンティティ", "陽だまり", "Evergreen", "Reflect", "PRECIOUS" ) );
