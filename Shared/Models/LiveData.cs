...
namespace ClariSLiveSetList.Shared.Models
{
    ...
    public class LiveDataManager
    {
        ...
        protected void InitializeTitleList()
        {
            ...
            TitleList.Add( "Radiant" );
            TitleList.Add( "Revive" );
            TitleList.Add( "Trigger" );
            TitleList.Add( "Umitsuki" );
        ...
        public LiveDataManager()
        {
            ...
            LiveList.Add( new LiveData(  4, "ClariS 1st Tour ～夢の1ページ…～", "Zepp Tokyo（東京都）", new DateTime(2016, 3, 19), "", "本当は", "Prism", "irony", "ハルラ", "カイト", "Dreamin’", "CLICK", "STEP", "border", "pastel", "nexus", "恋磁石", "YUMENOKI", "pieces", "カラフル", "with you", "アネモネ", "プロミス", "サヨナラは言わない", "グラスプ", "ひらひら ひらら", "encore", "ナイショの話", "コネクト" ) );
            LiveList.Add( new LiveData(  5, "ClariS 1st Tour ～夢の1ページ…～", "Zepp Tokyo（東京都）", new DateTime(2016, 3, 20), "", "本当は", "Prism", "irony", "ハルラ", "カイト", "Dreamin’", "CLICK", "STEP", "border", "pastel", "nexus", "恋磁石", "YUMENOKI", "pieces", "カラフル", "with you", "アネモネ", "プロミス", "サヨナラは言わない", "グラスプ", "ひらひら ひらら", "encore", "コネクト", "reunion", "graduation" ) );
            LiveList.Add( new LiveData(  6, "ClariS 1st HALL CONCERT in パシフィコ横浜国立大ホール ～星に願いを… 月に祈りを…～", "パシフィコ横浜国立大ホール（神奈川県）", new DateTime(2016, 9, 17), "", "コネクト", "CLICK", "STEP", "Clear Sky", "Reflect", "irony", "Prism", "眠り姫", "恋磁石", "Pastel", "blossom", "アワイ オモイ", "Don’t cry", "Friends", "ルミナス", "Tik Tak", "Gravity", "アネモネ", "ドライフラワー", "カラフル", "encore", "border", "clever" ) );
            LiveList.Add( new LiveData(  7, "ClariS 1st HALL CONCERT in パシフィコ横浜国立大ホール ～星に願いを… 月に祈りを…～", "パシフィコ横浜国立大ホール（神奈川県）", new DateTime(2016, 9, 18), "", "コネクト", "CLICK", "STEP", "Clear Sky", "Reflect", "irony", "nexus", "SECRET", "コイノミ", "Pastel", "blossom", "HANABI", "Don’t cry", "Pieces", "ルミナス", "Tik Tak", "Gravity", "アネモネ", "ドライフラワー", "カラフル", "encore", "ナイショの話", "clever", "reunion" ) );
            LiveList.Add( new LiveData(  8, "ClariS 1st 武道館コンサート ～2つの仮面と失われた太陽～", "日本武道館（東京都）", new DateTime(2017, 2, 10), "ライブBDあり", "again", "YUMENOKI", "RESTART", "border", "ホログラム", "pastel", "blossom", "眠り姫", "CLICK", "コネクト", "ルミナス", "カラフル", "水色クラゲ", "このiは虚数", "アネモネ", "ウソツキ", "Gravity", "DROP（kz remix）", "irony", "Clear Sky", "STEP", "recall", "encore", "clever", "ナイショの話", "reunion" ) );
            LiveList.Add( new LiveData(  9, "ClariS 2nd HALL CONCERT in パシフィコ横浜国立大ホール ～さよならの先へ...はじまりのメロディ～", "パシフィコ横浜国立大ホール（神奈川県）", new DateTime(2017, 9, 16), "仮面外す", "ヒトリゴト", "nexus", "プロミス", "Collage", "border -remix-", "Drawing", "Tik Tak", "CLICK", "ホログラム", "blossom", "again", "SECRET", "42nd STREET（カレンソロ）", "君の夢を見よう（クララソロ）", "Clear Sky", "reunion", "泣かないよ", "YUMENOKI", "サヨナラは言わない", "Prism", "カイト", "カラフル", "コネクト", "encore", "SHIORI", "Orange" ) );
            ...
            LiveList.Add( new LiveData( 27, "ClariS LIVE Tour 2019 ～libero～", "Zepp Tokyo（東京都）", new DateTime(2019, 10, 22), "台風により延期", "ナイショの話", "ダイアリー", "眠り姫", "YUMENOKI", "ルミナス", "Gravity", "with you", "SHIORI", "again", "Collage", "border", "Reflect", "eternally", "Wake Up", "ウソツキ", "HANABI", "Pieces", "Clear Sky", "メモリー", "I’m in love", "PRIMALove", "clever", "シニカルサスペンス", "RESTART", "シグナル", "encore", "仮面ジュブナイル", "secret base ～君がくれたもの～", "reunion"));
            LiveList.Add( new LiveData( 28, "ClariS 10th Anniversary Precious LIVE ～Gift～", "neo bridge（ネオブリッジ）", new DateTime(2020, 10, 20), "配信ライブ", "irony", "CLICK", "Clear Sky", "again", "border", "仮面ジュブナイル", "コネクト", "アリシア", "ヒトリゴト", "SHIORI", "ルミナス", "アネモネ", "CheerS", "STEP", "reunion", "ナイショの話", "PRECIOUS" ) );
            LiveList.Add( new LiveData( 29, "Merry ClarismaS ～ひみつのサンタクロース～", "neo bridge（ネオブリッジ）", new DateTime(2020, 12, 24), "配信ライブ", "サンタが街にやってくる", "Fairy Party", "Wake Up", "eternally", "メリクリ（メドレー）", "last christmas（メドレー）", "white love（メドレー）", "すてきなホリデイ（メドレー）", "恋人がサンタクロース（メドレー）", "ひとつだけ", "冬空花火", "シグナル", "ウソツキ", "グラスプ", "カラフル", "Prism" ) );
            ...
            LiveList.Add( new LiveData( 43, "ClariS Room Party ～Rhythm～", "TOKYO DOME CITY HALL(東京都）", new DateTime(2024, 05, 31), "ファンクラブイベント", "ココロの引力", "Don't cry", "Pieces", "アナタニFIT", "アイデンティティ", "サヨナラは言わない", "シルシ" ) );
            ...
            LiveList.Add( new LiveData( 48, "ClariS AUTUMN TOUR 2024 ～Via Fortuna～", "LINE CUBE SHIBUYA（東京都）", new DateTime( 2024, 10, 26, 13, 0, 0 ), "", "コネクト", "仮面ジュブナイル", "Prism", "CLICK", "again", "Gravity", "SHIORI", "blossom", "PRIMALove", "秋のグラディエント", "風は秋色", "木枯らしに抱かれて", "月のしずく", "思秋期", "ヒトリゴト", "CheerS", "アリシア", "ALIVE", "シニカルサスペンス", "Masquerade", "ふぉりら", "コイセカイ", "recall", "君がいると", "アイデンティティ", "陽だまり", "Evergreen", "encore", "Clear Sky", "PRECIOUS", "border" ) );
            LiveList.Add( new LiveData( 49, "ClariS AUTUMN TOUR 2024 ～Via Fortuna～", "LINE CUBE SHIBUYA（東京都）", new DateTime( 2024, 10, 26, 18, 0, 0 ), "", "コネクト", "仮面ジュブナイル", "Prism", "CLICK", "again", "Gravity", "SHIORI", "Brave", "アネモネ", "秋のグラディエント", "風は秋色", "木枯らしに抱かれて", "月のしずく", "思秋期", "ヒトリゴト", "CheerS", "シグナル", "ALIVE", "シニカルサスペンス", "Masquerade", "ふぉりら", "アンダンテ", "recall", "君がいると", "アイデンティティ", "陽だまり", "Evergreen", "encore", "Clear Sky", "PRECIOUS", "border" ) );
            LiveList.Add( new LiveData( 50, "ClariS AUTUMN TOUR 2024 ～Via Fortuna～", "カルッツかわさき（神奈川県）", new DateTime( 2024, 11, 2 ), "", "コネクト", "仮面ジュブナイル", "Prism", "CLICK", "again", "Gravity", "SHIORI", "blossom", "PRIMALove", "秋のグラディエント", "風は秋色", "木枯らしに抱かれて", "月のしずく", "思秋期", "ヒトリゴト", "CheerS", "アリシア", "ALIVE", "シニカルサスペンス", "Masquerade", "ふぉりら", "コイセカイ", "recall", "君がいると", "アイデンティティ", "陽だまり", "Evergreen", "encore", "Clear Sky", "PRECIOUS", "border" ) );
            LiveList.Add( new LiveData( 51, "ClariS AUTUMN TOUR 2024 ～Via Fortuna～", "カルッツかわさき（神奈川県）", new DateTime( 2024, 11, 3 ), "", "コネクト", "仮面ジュブナイル", "Prism", "CLICK", "again", "Gravity", "SHIORI", "Brave", "アネモネ", "秋のグラディエント", "風は秋色", "木枯らしに抱かれて", "月のしずく", "思秋期", "ヒトリゴト", "CheerS", "シグナル", "ALIVE", "シニカルサスペンス", "Masquerade", "ふぉりら", "アンダンテ", "recall", "君がいると", "アイデンティティ", "陽だまり", "Evergreen", "encore", "Clear Sky", "PRECIOUS", "border" ) );
            LiveList.Add( new LiveData( 52, "ClariS AUTUMN TOUR 2024 ～Via Fortuna～", "Zepp Namba（大阪府）", new DateTime( 2024, 11, 10 ), "カレン卒業公演", "Clear Sky", "コネクト", "仮面ジュブナイル", "Prism", "CLICK", "again", "Gravity", "SHIORI", "blossom", "秋のグラディエント", "風は秋色", "木枯らしに抱かれて", "月のしずく", "思秋期", "border", "ヒトリゴト", "CheerS", "アリシア", "ALIVE", "シニカルサスペンス", "ふぉりら", "コイセカイ", "recall", "君がいると", "アイデンティティ", "陽だまり", "Evergreen", "encore", "Reflect", "PRECIOUS" ) );
            LiveList.Add( new LiveData( 53, "ClariS -03- 1st TOUR 2026 ～Trigger Anthem～", "Zepp Haneda（東京都）", new DateTime( 2026, 4, 17 ), "3rd season first live", "Trigger", "ALIVE", "again", "border", "ルミナス", "リンクス", "Radiant", "運命", "ひらひら ひらら", "Umitsuki", "One more voice", "カラフル", "ケアレス", "ヒトリゴト", "CLICK", "irony", "reunion", "ナイショの話", "コネクト", "encore", "Revive", "タカラモノ" ) );
            LiveList.Add( new LiveData( 54, "ClariS -03- 1st TOUR 2026 ～Trigger Anthem～", "Zepp Osaka Bayside（大阪府）", new DateTime( 2026, 4, 26 ), "", "Trigger", "ALIVE", "again", "border", "ルミナス", "リンクス", "Radiant", "運命", "ひらひら ひらら", "Umitsuki", "One more voice", "カラフル", "ケアレス", "ヒトリゴト", "CLICK", "irony", "reunion", "ナイショの話", "コネクト", "encore", "Revive", "タカラモノ" ) );
            LiveList.Add( new LiveData( 55, "ClariS 15th Thanks Tour ～一夏灯祭～", "TOKYO DOME CITY HALL（東京都）", new DateTime( 2026, 7, 11 ), "", "お祭りマンボ", "Revive", "ヒトリゴト", "Umitsuki", "Summer Delay", "Radiant", "ALIVE", "青い珊瑚礁(クララソロ)", "サウダージ(アンナソロ)", "いのちの名前(エリーソロ)", "夏祭り(メドレー)", "暑中お見舞い申し上げます(メドレー)", "secret base ～君がくれたもの～(メドレー)", "One more voice", "Mermaid", "一期一会", "未来航路", "ナイショの話", "幻想恋慕", "シニカルサスペンス", "ケアレス", "コネクト", "Trigger", "encore", "ヒトコト", "border", "タカラモノ", "お祭りマンボ" ) );
            LiveList.Add( new LiveData( 56, "ClariS 15th Thanks Tour ～一夏灯祭～", "TOKYO DOME CITY HALL（東京都）", new DateTime( 2026, 7, 12 ), "", "お祭りマンボ", "Revive", "ヒトリゴト", "Umitsuki", "Summer Delay", "Radiant", "ALIVE", "青い珊瑚礁(クララソロ)", "サウダージ(アンナソロ)", "いのちの名前(エリーソロ)", "夏祭り(メドレー)", "暑中お見舞い申し上げます(メドレー)", "secret base ～君がくれたもの～(メドレー)", "One more voice", "Mermaid", "一期一会", "未来航路", "ナイショの話", "幻想恋慕", "シニカルサスペンス", "ケアレス", "コネクト", "Trigger", "encore", "ヒトコト", "border", "タカラモノ", "お祭りマンボ" ) );
            LiveList.Add( new LiveData( 57, "ClariS 15th Thanks Tour ～一夏灯祭～", "Zepp Nagoya（愛知県）", new DateTime( 2026, 9, 11 ), "", "お祭りマンボ", "Revive", "ALIVE", "ヒトリゴト", "Umitsuki", "Radiant", "Summer Delay", "花火(クララソロ)", "サウダージ(アンナソロ)", "いのちの名前(エリーソロ)", "HANABI", "Mermaid", "One more voice", "夏の面影", "一期一会", "KOIYAGURA", "未来航路", "幻想恋慕", "シニカルサスペンス", "ケアレス", "コネクト", "Trigger", "encore", "ヒトコト", "border", "タカラモノ" ) );
            LiveList.Add( new LiveData( 58, "ClariS 15th Thanks Tour ～一夏灯祭～", "オリックス劇場（大阪府）", new DateTime( 2026, 9, 13 ), "", "お祭りマンボ", "Revive", "ALIVE", "ヒトリゴト", "Umitsuki", "Radiant", "Summer Delay", "花火(クララソロ)", "サウダージ(アンナソロ)", "いのちの名前(エリーソロ)", "HANABI", "Mermaid", "One more voice", "夏の面影", "一期一会", "KOIYAGURA", "未来航路", "幻想恋慕", "シニカルサスペンス", "ケアレス", "コネクト", "Trigger", "encore", "ヒトコト", "border", "タカラモノ" ) );
            LiveList.Add( new LiveData( 59, "ClariS 15th Thanks Tour ～一夏灯祭～", "SGC HALL ARIAKE（東京都）", new DateTime( 2026, 9, 18 ), "アンナ欠席", "お祭りマンボ", "Revive", "ヒトリゴト", "Umitsuki", "Summer Delay", "Radiant", "ALIVE", "青い珊瑚礁(クララソロ)", "いのちの名前(エリーソロ)", "HANABI", "Mermaid", "One more voice", "夏の面影", "一期一会", "KOIYAGURA", "未来航路", "幻想恋慕", "シニカルサスペンス", "ケアレス", "コネクト", "Trigger", "encore", "ヒトコト", "border", "タカラモノ" ) );
